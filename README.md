...
- **文型**: 第1〜5文型とその受動態
- **句・節**: 不定詞、動名詞、不定詞と動名詞の識別、分詞、分詞構文、関係代名詞、関係副詞
...
- **不定詞**
  ...
  - `infinitive_logical_subject` - 不定詞の意味上の主語（for + 名詞 + to不定詞、動詞の目的語としての不定詞）
- **動名詞**
  - `gerund` - 動名詞（目的語に取る動詞、意味上の主語、否定）
  - `gerund_logical_subject` - 動名詞の意味上の主語（所有格・目的格 + 動名詞、正式・口語表現の使い分け）
- `infinitive_gerund_identification` - 不定詞と動名詞の識別（動詞の目的語の形、意味の違い）
